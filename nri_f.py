# code by zqr2008 publihsed at https://github.com/zqr2008/nri_idi/
...
def nri_cal(df,n):
    ...
    z_nri_ev = nri_ev / se_nri_ev if se_nri_ev != 0 else np.nan #Z score for NRI of events
    ...
    z_nri_ne = nri_ne / se_nri_ne if se_nri_ne != 0 else np.nan #Z score for NRI of non-events
    ...
    z_nri = nri / se_nri if se_nri != 0 else np.nan #Z score for NRI
